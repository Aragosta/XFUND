#!/usr/bin/env python3
"""Multi-TASK trend learning (not ensembling): does forcing ONE model to predict multiple future
horizons jointly [t+1,t+2,t+3] learn a cleaner TREND than predicting t+1 alone?
...
def zc(s): return (s - s.mean()) / (s.std() + 1e-9)                    # cross-sectional z-score
...
print("\n" + "=" * 66)
print("=== Multi-task trend: single t+1 regressor vs joint [t+1,t+2,t+3] ===")
